...
public class May extends Month {
  ...
  public May(Unit unitValue) {
    this.unitValue = unitValue;
  }

  public Variant toValue() {
    return new Variant("May", Unit.getInstance());
  }

  public static May fromValue(Value value$) throws IllegalArgumentException {
    Variant variant$ = value$.asVariant().orElseThrow(() -> new IllegalArgumentException("Expected: Variant. Actual: " + value$.getClass().getName()));
    if (!"May".equals(variant$.getConstructor())) throw new IllegalArgumentException("Invalid constructor. Expected: May. Actual: " + variant$.getConstructor());
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof May)) {
      return false;
    }
    May other = (May) object;
  ...
  public String toString() {
    return String.format("May(%s)", this.unitValue);
  }
}
